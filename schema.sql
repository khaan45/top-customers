...
-- Issued after a student passes the eligibility checkboxes (post-OTP-removal).
-- The frontend sends this token on /api/vote; the server treats it as the
-- only proof of "this browser is speaking for this student_id" it has.
